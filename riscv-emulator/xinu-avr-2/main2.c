...
*/
    ...
    //resume(create(blink, 32, 100, "blink",5, "parpadeo","daniel","eduardo","quintero","villegas"));
	//resume(create(core1, 32, 100, "thread",1, "activo"));

 

   // if(open(EEPROM0,"/dev/eeprom0","w")==SYSERR){
     //   printf("ok eeprom\n" );
    //}
